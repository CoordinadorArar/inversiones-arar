...
/**
 * Request para validar Tipos de Identificación
 * 
...
class TipoIdentificacionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'nombre' => [
                ...
                Rule::unique('tipos_identificaciones', 'nombre')
                    ->ignore($id)
            ...
            'abreviatura' => [
                ...
                'max:10',
                'regex:/^[a-zA-Z]+$/',
                Rule::unique('tipos_identificaciones', 'abreviatura')
                    ->ignore($id)
                    ->whereNull('deleted_at'),
            ],
        ];
    ...
    public function messages(): array
    {
        return [
            ...
            'nombre.unique' => 'Ya existe un tipo de identificación con este nombre',
            ...
            'abreviatura.unique' => 'Ya existe un tipo de identificación con esta abreviatura',
        ];
    }
