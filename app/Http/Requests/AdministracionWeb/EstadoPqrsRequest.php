...
/**
 * Request para validar Estados de PQRSD
 * 
 * @author Yariangel Aray
 * @date 2025-12-03
 */
class EstadoPqrsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'nombre' => [
                ...
                Rule::unique('estados_pqrs', 'nombre')
                    ->ignore($id)
            ...
            'abreviatura' => [
                ...
                'max:10',
                'regex:/^[a-zA-Z]+$/',
                Rule::unique('estados_pqrs', 'abreviatura')
                    ->ignore($id)
                    ->whereNull('deleted_at'),
            ],
        ];
    ...
    public function messages(): array
    {
        return [
            ...
            'nombre.unique' => 'Ya existe un estado de pqrs con este nombre',
            ...
            'abreviatura.unique' => 'Ya existe un estado de pqrs con esta abreviatura',
        ];
    }
