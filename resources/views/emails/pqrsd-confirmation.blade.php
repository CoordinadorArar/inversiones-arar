...
<h1 class="email-title"> @if($data['letra_pqrs'] == 'D') ¡Denuncia @else ¡PQRS @endif Recibida!</h1>
@endsection
...
<div class="mb-4">
    ...
    <p class="text-muted" style="font-size: 15px; line-height: 1.7;">
        Hemos recibido satisfactoriamente su @if($data['letra_pqrs'] == 'D') denuncia @else PQRS @endif. Gracias por tomarse el tiempo de informarnos sobre esta situación.
    </p>
</div>
...
<div class="radicado-box">
    ...
    <div class="radicado-number">#{{ $data['radicado'] }}</div>
...
<div class="card card-highlight mb-4">
    ...
    <div style="font-size: 14px; line-height: 1.8;">
        <div style="margin-bottom: 12px;">
            ...
            Su @if($data['letra_pqrs'] == 'D') denuncia @else PQRS @endif será revisada cuidadosamente por el área encargada
        </div>
        <div style="margin-bottom: 12px;">
